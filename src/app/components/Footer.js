  ...
  return (
    <footer className="bg-black text-white pt-24 pb-12 px-6">
      ...
      <div className="text-center mb-16">
        <Image src="/logo/logowhite.png" alt="Cleope Logo" width={400} height={400} className="mx-auto mb-2" />
      </div>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-16">
        ...
        <div className="flex flex-col gap-10">
          {/* Social */}
          <div>
            <h4 className="text-md font-semibold uppercase mb-2 tracking-wide">Social</h4>
            <div className="flex gap-4">
              <a href="https://instagram.com/cleopeofficial" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://tiktok.com/@cleopeofficial" target="_blank" rel="noopener noreferrer">
        ...
        <div className="flex flex-col items-start md:items-end">
          <h4 className="text-md font-semibold uppercase mb-2 tracking-wide">Pages</h4>
          <ul className="flex flex-col gap-1 text-sm">
            <li><Link href="/" className="hover:underline uppercase text-xs">Home</Link></li>
            <li><Link href="/nextevents" className="hover:underline uppercase text-xs">Events</Link></li>
            <li><Link href="/about" className="hover:underline uppercase text-xs">The Hub</Link></li>
            <li><Link href="/tables" className="hover:underline uppercase text-xs">Tables</Link></li>
          </ul>
        </div>
      </div>

      {/* Bottom */}
      <div className="mt-16 border-t border-white/10 pt-6 text-center text-[12px] text-neutral-400">
        <p>&copy; 2026 <strong>CLEOPE HUB</strong> — A Made in Italy Project.</p>
      </div>
    </footer>
  );
};