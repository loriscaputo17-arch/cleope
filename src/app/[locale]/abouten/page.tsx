                ...
                <Flex
                    ...
                    <Flex
                        ...
                        <Text
                            ...
                            CLEOPE is an innovative fashion party that combines music, entertainment, and fashion in exclusive locations.                        </Text>
                        {social.length > 0 && (
                            <Flex
                                className={styles.blockAlign}
...
The fashion party brings together DJ sets, cocktail bars, brand exhibitions, and runway shows right on the dance floor.                        </Flex>
                    )}
                                ...
                                {about.work.experiences.map((experience, index) => (
                                    <Flex
                                        ...
                                        <Flex
                                            ...
                                            {experience.achievements2.map((achievement: string, index: any) => (
                                                <Text
                                                    as="li"
